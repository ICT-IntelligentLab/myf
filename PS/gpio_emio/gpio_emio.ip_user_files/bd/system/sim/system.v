...
module system
   (DDR_addr,
    ...
    FIXED_IO_ps_porb,
    FIXED_IO_ps_srstb,
    GPIO_EMIO_KEY2_tri_i,
    GPIO_EMIO_KEY2_tri_o,
    GPIO_EMIO_KEY2_tri_t);
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO_EMIO_KEY2 " *) input [0:0]GPIO_EMIO_KEY2_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO_EMIO_KEY2 " *) output [0:0]GPIO_EMIO_KEY2_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO_EMIO_KEY2 " *) output [0:0]GPIO_EMIO_KEY2_tri_t;
  ...
  assign GPIO_EMIO_KEY2_tri_o[0] = processing_system7_0_GPIO_0_TRI_O;
  assign GPIO_EMIO_KEY2_tri_t[0] = processing_system7_0_GPIO_0_TRI_T;
  assign processing_system7_0_GPIO_0_TRI_I = GPIO_EMIO_KEY2_tri_i[0];
