...
HD_PWD='c:/users/admin/desktop/vivado_projects/ps/ip/managed_ip_project/managed_ip_project.tmp/breath_led_ip_v1_0_project/breath_led_ip_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log breath_led_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source breath_led_ip_v1_0.tcl
