...
simulate()
{
  xsim system -key {Behavioral:sim_1:Functional:system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_a17c.protoinst" -protoinst "protoinst_files/bd_31bd.protoinst" -protoinst "protoinst_files/bd_c0fd.protoinst" -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
